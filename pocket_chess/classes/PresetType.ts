export interface PresetTypeJSON {
    id: number;
    name: string;
...
export default class PresetType {
    ...
    constructor(id: number, name: string, short_description: string, long_description: string) {
        this.id = id;
        this.name = name;
    ...
    static fromJSON(json: PresetTypeJSON): PresetType {
...
export const PresetTypes: Record<string, PresetType> = {
...
export const PresetIdToTypes: Record<number, PresetType> = {
...
export const PresetTypeSections: Record<string, PresetType[]> = {
    "popular": [
