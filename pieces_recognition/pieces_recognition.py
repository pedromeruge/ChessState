...
def build_pretrained_CNN(input_dataset_folder, output_folder):
    try :
        input_dir = Path(input_dataset_folder)
        output_dir = Path(output_folder)
        ...
        x = Dense(2, activation='softmax')(x)  # dense layer with 2 nodes for each class and softmax activation
